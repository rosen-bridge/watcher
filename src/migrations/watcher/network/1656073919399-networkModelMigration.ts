    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "commitment_entity" 
                (
                    ...
                    "commitmentTxId" varchar NOT NULL, 
                    "flag" varchar CHECK( "flag" IN ('sent','created','merged','unused') ) NOT NULL
                )`
        );
        ...
        await queryRunner.query(`CREATE TABLE "observation_entity" 
                (
                    ...
                    CONSTRAINT "FK_c1c9e3913095e63b4ab32304aa7" FOREIGN KEY ("blockHeight") 
                        REFERENCES "block_entity" ("height") ON DELETE CASCADE ON UPDATE NO ACTION
                )`
        );
    }

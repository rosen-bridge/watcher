...
export class bridgeModelMigration1656151359971 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "bridge_block_entity" 
                (
        ...
        await queryRunner.query(`CREATE TABLE "box_entity" 
                (
                    ...
                    CONSTRAINT "FK_cbd976955f2cce93fda0069865e" FOREIGN KEY ("blockHeight") 
                        REFERENCES "bridge_block_entity" ("height") ON DELETE CASCADE ON UPDATE NO ACTION,
                    CONSTRAINT "FK_443356c00a735cbccb805f893d0" FOREIGN KEY ("spendBlockHeight") 
                        REFERENCES "bridge_block_entity" ("height") ON DELETE SET NULL ON UPDATE NO ACTION
                )`
        );
        await queryRunner.query(`CREATE TABLE "observed_commitment_entity" 
                (
                    "id" integer PRIMARY KEY NOT NULL,

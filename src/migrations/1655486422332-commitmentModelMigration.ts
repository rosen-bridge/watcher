...
export class commitmentModelMigration1655486422332 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE TABLE "observed_commitment_entity" ("id" integer PRIMARY KEY NOT NULL, "eventId" varchar NOT NULL, "commitment" varchar NOT NULL, "WID" varchar NOT NULL, "commitmentBoxId" varchar NOT NULL, "eventTriggerBoxId" varchar, "blockHeight" integer, "spendBlockHeight" integer,
        ...
        await queryRunner.query(
            `CREATE TABLE "box_entity" ("id" integer PRIMARY KEY NOT NULL, "boxId" varchar NOT NULL, "value" bigint NOT NULL, "type" varchar CHECK( "type" IN ('permit','wid','plain') ) NOT NULL, "boxJson" varchar NOT NULL, "blockHeight" integer, "spendBlockHeight" integer,

...
export class commitmentModelMigration1655486422332 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "box_entity" ("id" integer PRIMARY KEY NOT NULL, "boxId" varchar NOT NULL, "value" bigint NOT NULL, "type" varchar CHECK( "type" IN ('permit','wid','plain') ) NOT NULL, "boxJson" varchar NOT NULL, "blockHeight" integer, "spendBlockHeight" integer, CONSTRAINT "FK_cbd976955f2cce93fda0069865e" FOREIGN KEY ("blockHeight") REFERENCES "c_block_entity" ("height") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_443356c00a735cbccb805f893d0" FOREIGN KEY ("spendBlockHeight") REFERENCES "c_block_entity" ("height") ON DELETE SET NULL ON UPDATE NO ACTION)`);
    }

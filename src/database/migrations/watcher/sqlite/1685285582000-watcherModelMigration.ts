...
export class watcherModelMigration1685285582000 implements MigrationInterface {
  name = 'watcherModelMigration1685285582000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
            CREATE TABLE "temporary_tx_entity" (
                ...
                "type" varchar CHECK("type" IN ('commitment', 'trigger', 'detach', 'redeem', 'permit')) NOT NULL,

...
export class networkModelMigration1660624455730 implements MigrationInterface {
    name = 'networkModelMigration1660624455730'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "observation_status_entity" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "status" varchar CHECK( "status" IN ('0','1','2','3','4','5') ) NOT NULL, "observationId" integer, CONSTRAINT "REL_0a64720aa46fb4fd199a0285df" UNIQUE ("observationId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_observation_status_entity" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "status" varchar CHECK( "status" IN ('0','1','2','3','4','5') ) NOT NULL, "observationId" integer, CONSTRAINT "REL_0a64720aa46fb4fd199a0285df" UNIQUE ("observationId"), CONSTRAINT "FK_0a64720aa46fb4fd199a0285df2" FOREIGN KEY ("observationId") REFERENCES "observation_entity" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "observation_status_entity" RENAME TO "temporary_observation_status_entity"`);
        await queryRunner.query(`CREATE TABLE "observation_status_entity" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "status" varchar CHECK( "status" IN ('0','1','2','3','4','5') ) NOT NULL, "observationId" integer, CONSTRAINT "REL_0a64720aa46fb4fd199a0285df" UNIQUE ("observationId"))`);
        await queryRunner.query(`INSERT INTO "observation_status_entity"("id", "status", "observationId") SELECT "id", "status", "observationId" FROM "temporary_observation_status_entity"`);
        await queryRunner.query(`DROP TABLE "temporary_observation_status_entity"`);
        await queryRunner.query(`DROP TABLE "tx_entity"`);
        await queryRunner.query(`DROP TABLE "observation_status_entity"`);

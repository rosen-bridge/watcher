 ...
 * @param networkType
 */
const generateSK = (networkType: wasm.NetworkPrefix = wasm.NetworkPrefix.Mainnet): { address: string, secret: string} => {
 ...
 * @param networkType
 */
const ergoTreeToBase58Address = (ergoTree: wasm.ErgoTree,
